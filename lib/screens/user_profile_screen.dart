...
class _UserProfileScreenState extends State<UserProfileScreen> {
    ...
    return SafeArea(
      child: Scaffold(
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      text(context, 'Profile', textColor, 16.0, FontWeight.bold,
                          TextDecoration.none),
                      Spacer(),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            text(context, 'Andrea Hirata', textColor, 16.0,
                                FontWeight.normal, TextDecoration.none),
                            addVerticalSpace(sizedBoxHeightWidth / 2),
                            text(context, 'hirata@gmail.com', Colors.grey, 14.0,
                                FontWeight.normal, TextDecoration.none),
                          ],
                        ),
                      )
                ...
                addVerticalSpace(
                    sizedBoxHeightWidth + (sizedBoxHeightWidth / 2)),
                addDivider(),
                //starting or General
                addVerticalSpace(sizedBoxHeightWidth),
                Padding(
                  padding: edgeInsetsPadding,
                  child: text(context, 'General', Colors.grey, 14.0,
                      FontWeight.normal, TextDecoration.none),
                ),
                addVerticalSpace(sizedBoxHeightWidth),
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: ['Edit Profile', 'Notifications', 'Whishlist']
                      .map((text) => Items(text))
                      .toList(),
                ),
                ...
                Padding(
                  padding: edgeInsetsPadding,
                  child: text(context, 'Legal', Colors.grey, 14.0,
                      FontWeight.normal, TextDecoration.none),
                ),
                addVerticalSpace(sizedBoxHeightWidth),
                ...
                Padding(
                  padding: edgeInsetsPadding,
                  child: text(context, 'Personal', Colors.grey, 14.0,
                      FontWeight.normal, TextDecoration.none),
                ),
                addVerticalSpace(sizedBoxHeightWidth),
        ...
        floatingActionButton:
            GenericFloatingActionButton(context, '/add_item_card_overview'),
      ),
    );
  }
  ...
  Widget GenericFloatingActionButton(
      BuildContext context, String pageClassString) {
    return FloatingActionButton(
      ...
      onPressed: () {
        Navigator.pushNamed(context, pageClassString);
      },
    );
  }
}
